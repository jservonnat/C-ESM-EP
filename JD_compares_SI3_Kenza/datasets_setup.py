...
if onCiclad or atTGCC or onSpirit:
    models = [
        ...
        dict(project='IGCM_OUT',
               ...
               color='green',
               gridfile='/projets/nemo-rd/IPSLCM/AREA/eORCA1.4.2_grid.nc',
               varname_area='AREA',
               )
        #dict(project='IGCM_OUT',
        #       login='p86fair',
        ...
        #       color='green',
        #       gridfile='/projets/nemo-rd/IPSLCM/AREA/eORCA1.2_grid.nc',
        #       varname_area='AREA',
        #       ),
    ]
    if atTGCC:
    ...
    common_keys = dict(
        ...
        gridfile='/data/cetlod/grids/eORCA1.4.2_grid.nc',
        varname_area='AREA',
        #gridfile='/scratchu/khimmich/CMIP7_EVAL_OBS/SIT/mask_valid_sit_SSMI-SSMIS_nemo.nc',
        #varname_area='area',
    )
    #
    for model in models:
