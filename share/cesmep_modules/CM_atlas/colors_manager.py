...
# -- R
cesmep_R_colors = ['dodgerblue3', 'firebrick1', 'green4', 'darkturquoise', 'goldenrod1', 'navyblue', 'green2',
                   'steelblue', 'deeppink', 'blue', 'darkgoldenrod2', 'yellowgreen', 'darkorchid3', 'darkgoldenrod',
                   'darkgreen', 'orchid3', 'slategray', 'gold', 'green', 'saddlebrown', 'tan', 'coral', 'violetred',
                   'aquamarine2', 'firebrick']
# -- python
cesmep_python_colors = ['royalblue', 'red', 'green', 'mediumturquoise', 'orange', 'navy', 'limegreen', 'steelblue',
                        'fuchsia', 'blue', 'goldenrod', 'yellowgreen', 'blueviolet', 'darkgoldenrod', 'darkgreen',
                        'mediumorchid', 'lightslategray', 'gold', 'chartreuse', 'saddlebrown', 'tan', 'tomato',
                        'mediumvioletred', 'mediumspringgreen', 'firebrick', ]
...
for tmpcolor in mpcolors:
    if tmpcolor in cesmep_python_colors:
        mpcolors.remove(tmpcolor)
