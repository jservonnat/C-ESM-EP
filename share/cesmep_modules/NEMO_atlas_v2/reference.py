def variable2reference(variable, project=None):
    if not project:
        if variable in ['pr', 'prw', 'rlut', 'rsut', 'rlutcs', 'rsutcs', 'rlus', 'rsus', 'rluscs', 'rsuscs', 'rlds',
                        'rsds',
                        'rsdscs', 'rldscs', 'tas', 'ta', 'ua', 'va', 'psl', 'uas', 'vas', 'tos', 'sos', 'zos', 'hus',
                        'mlotst', 'alb',
    ...
    refs = {
        'ref_climatos': {
            'CERES': ['rlut', 'rsut', 'rlutcs', 'rsutcs', 'rlus', 'rsus', 'rluscs', 'rsuscs', 'rlds', 'rsds', 'rsdscs',
                      'rldscs'],
