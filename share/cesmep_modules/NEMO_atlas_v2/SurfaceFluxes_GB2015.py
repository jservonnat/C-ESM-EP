...
def plot_bias_TurbFlux_vs_GB2015(variable, dat, climatology='ANM', region='Tropics', add_product_in_title=True,
    ...
    options = 'pmLabelBarWidthF=0.065|pmLabelBarOrthogonalPosF=0.01|lbLabelFontHeightF=0.01|' \
              'tmXBLabelFontHeightF=0.01|tmYLLabelFontHeightF=0.01'
    #
