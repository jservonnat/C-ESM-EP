...
proj = 'Satellite'
# domain = dict(lonmin=0, lonmax=360, latmin=-30, latmax=30) # -> set domain = dict(lonmin=X1, lonmax=X2, latmin=Y1,
#                                                            #    latmax=Y2)
domain = {}
...
# -- with a variable)
# ---------------------------------------------------------------------------- >
# -> [LMDZ_SE Atlas] builds a section with a list of standard atmospheric variables (2D maps and zonal means)
do_atmos_maps = True
...
for var in atmos_variables_list:
    for seas in my_seasons:
        atmos_variables.append(dict(variable=var, season=seas, proj='Satellite', mpCenterLonF='-40',
                                    options="mpCenterLatF=45|mpSatelliteDistF=3"))
