...
# colorpalette = ['dodgerblue3','orangered','mediumseagreen','firebrick3','yellow1','royalblue','deepskyblue',
#                 'violetred2','mediumturquoise','cadetblue']
colorpalette = ['dodgerblue3', 'orangered', 'green2', 'yellow3', 'navyblue', 'darkturquoise', 'mediumseagreen',
