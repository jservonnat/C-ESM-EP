...
kwargs = dict(models=Wmodels, reference=reference, proj=proj, season=season, variables=atlas_explorer_variables,
              section_title='Atmosphere Standard Pressure Levels', domain=domain, custom_plot_params=custom_plot_params,
...
if atlas_explorer_climato_variables:
   ...
   kwargs.update(dict(variables=atlas_explorer_climato_variables, section_title='Atmosphere Standard Pressure Levels Climatologies'))
   #
   if do_parallel:
