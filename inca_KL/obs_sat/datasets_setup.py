...
my_projects = {'definitions': ['pathfilename', 'frequency'],
               'Satellite': ['/ccc/work/cont003/gen0826/laurentk/data_AURA/MLS-Aura_L3DB-N2O_v04-23-c01_2005_PressureZM.nc',
                                       ""],
               'HALOE': ['/ccc/work/cont003/gen0826/fallettl/OBS_data/HALOE/haloe_lat_climat.nc',
                                       ""]
              }
...
if onCiclad or atTGCC or onSpirit:
    models = [
        ...
        dict(project='IGCM_OUT',
             root='/ccc/store/cont003/gen2201',
             login='laurentk',
             model='LMDZORINCA',
             experiment='GES',
             simulation='hist.ipsl',
             frequency='monthly',
             OUT='Output',
             DIR='CHM',
             status='PROD',
             clim_period='19900101_19901231',
             customname='historical',
             color='green'
             ),
...
reference = 'default'
#dict(project='Satellite', period='2005_2005', frequency='daily', product='value')
#reference = dict(project='IGCM_OUT', DIR='CHM', model='IPSLCM5A2CHT', experiment='historical', simulation='CM5A2CHT1-VLR-hist-06', 
#                 status='PROD', login='p24cozic', root='/ccc/store/cont003/gencmip6',
#                 frequency='daily', period='19000101_19491231',
#                 customname='cm5a2_06'
#                )
...
# -- Set default values
#cdef('simulation'  , 'piC.map4.ipsl', project='GES_comp')
#cdef('model'       , 'LMDZORINCA'   , project='GES_comp')
#cdef('experiment'  , 'GES'          , project='GES_comp')
#cdef('compn'       , 'CHM'          , project='GES_comp')
#cdef('realm'       , '*'            , project='GES_comp')
# -- Define the pattern
##pattern="/ccc/work/cont003/gen0826/laurentk/dataAURA/MLS-Aura_L3DB-N2O_v04-23-c01_2005_PressureZM.nc"
...
##dataloc(project='Satellite', organization='generic', url=pattern)
# ---------------------------------------------------------------------------- >
# -- Add your obs to the custom_obs_dict
custom_obs_dict = {
        'vmrn2o':dict(project='Satellite', do_zonmean=False, period='fx', frequency='daily', product='SatAURA', customname='name satellite'),
