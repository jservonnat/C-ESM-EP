...
if atlas_head_title is None :
    atlas_head_title = "Atmosphere South Pole projection"
...
if atlas_explorer_climato_variables:
    ...
    kwargs.update(dict(variables=atlas_explorer_climato_variables, section_title='Atmosphere South Pole Climatologies (at 200 hPa)'))
    #
    if do_parallel:
