...
from orchidee_variables_and_functions import average_over_region, integral_over_region
...
special_project_specs = {
    ...
    'ratio_ep'    : { 'IGCM_OUT' : { 'DIR': 'SRF'}, 'CMIP6' : { 'table': 'Amon'}},
    }
...
variables_specifics = {
    "cLitter" : { "global_sum_scale" : ( 1.E-12, "PgC") },
    "ratio_ep" : { "ratio":"evspsbl/pr", "units" : "", "ratio_threshold":"1E-3"},
}
...
time_series_setup = {
    ...
    'cLitter' : dict(operation = integral_over_region),
    }
