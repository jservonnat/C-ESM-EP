...
# ---------------------------------------------------------------------------- >
atlas_head_title = "INCA - Atmospheric UT"
...
kwargs = dict(models=Wmodels, reference=reference, proj=proj, season=season, variables=atlas_explorer_variables,
              section_title='Atmosphere Upper Tropo (at 200hPa)', domain=domain, custom_plot_params=my_dict_plot_params,
...
if atlas_explorer_climato_variables:
    ...
    kwargs.update(dict(variables=atlas_explorer_climato_variables,
                  section_title='Atmosphere Upper Troposphere Climatologies (at 200hPa)'))
    #
    if do_parallel:
