...
# ----------------------------------------------
# --                                             \
# --  SH Polar St. - Atmosphere Surface           \
# --                                              /
# --                                             /
# --                                            /
# ---------------------------------------------
...
if atlas_head_title is None :
    atlas_head_title = "INCA - North Pole projection"
...
kwargs = dict(models=Wmodels, reference=reference, proj=proj, season=season, variables=atlas_explorer_variables,
              section_title='North projection (at 200 hPa)', domain=domain, custom_plot_params=my_dict_plot_params,
...
if atlas_explorer_climato_variables:
    ...
    kwargs.update(dict(variables=atlas_explorer_climato_variables, section_title='North Pole Climatologies (at 200 hPa)'))
    #
    if do_parallel:
